Factory.define :curated_feed_item do |f|
  f.url "http://blog.cleveland.com/metro/2011/05/global_cleveland_will_launch_w.html"
  ...
  f.objectify File.open("#{File.dirname(__FILE__)}/../fixtures/curated_feed_objectify.json", 'rb') { |f| f.read }
