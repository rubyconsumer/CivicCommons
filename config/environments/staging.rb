...
Civiccommons::Application.configure do
  ...
  config.assets.precompile += %w( admin.js ie7_jsIE9.js ie7_js/ie7-recalc.js show_colorbox.js activities.embed.js tiny_mce/tiny_mce.js )
  config.assets.precompile += %w( ie.css admin.css widget.css )
