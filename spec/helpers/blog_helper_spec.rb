...
describe BlogHelper do
  ...
  describe "blog_filter_by_author_link" do
    ...
    it "should show the correct link having author_id param when author is different than current author" do
      ...
      helper.blog_filter_by_author_link(author,current_author).should == "<a href=\"/blog?author_id=123\" class=\"\"><img alt=\"John Author\" class=\"mem-img\" height=\"16\" src=\"/assets/avatar.jpg\" title=\"John Author\" width=\"16\" /><span>John Author</span></a>"
    end
    it "should show 'active' when author is the same as current_author" do
      ...
      helper.blog_filter_by_author_link(author,current_author).should == "<a href=\"/blog\" class=\"active\"><img alt=\"John Author\" class=\"mem-img\" height=\"16\" src=\"/assets/avatar.jpg\" title=\"John Author\" width=\"16\" /><span>John Author</span></a>"
    end
  end
end
