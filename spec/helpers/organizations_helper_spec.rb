...
describe OrganizationsHelper do
  ...
  context "organization_membership_button" do
    ...
    it "should return the correct button if user is a member" do
      ...
      helper.organization_membership_button(organization, mock_person).should == "<p class=\"membership\"><a href=\"/user/123/remove_membership\" class=\"button remove\" data-method=\"delete\" data-remote=\"true\" data-type=\"html\" rel=\"nofollow\">Leave this organization</a></p>"
    end
    it "should return the correct button if user is not a member" do
      organization = mock_organization(:id => 123)
      organization.stub!(:has_member?).and_return(false)
      helper.organization_membership_button(organization, mock_person).should == "<p class=\"membership\"><a href=\"/user/123/join_as_member\" class=\"button join\" data-type=\"html\">I'm a member of this Organization</a></p>"
    end
  end
end
